...
## Project Structure
    ...
    ├── catalog_update_ivan_40892  # Django project configurations
...
1. Clone this repo and `cd catalog_update_ivan_40892`
...
2. Clone this repo and `cd catalog_update_ivan_40892`
